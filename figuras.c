 ...
 * La ejecución comienza aquí, coordinando las llamadas a las funciones
 * necesarias para mostrar el contenido de cada archivo de figura.
 */
int main() {
...
void mostrar_figura(const char* nombre_archivo) {
    ...
    // Es una buena práctica cerrar siempre los archivos que se abren.
    fclose(archivo);
}